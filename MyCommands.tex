...
\newtheorem{defini}{Definition}[subsection] % Création de l'environnement exo dont le numérotage est indépendant des autres environnement
\newtheorem{remarque}{Remarque}[subsection] % Création de l'environnement question dont le numerotage depend de l'environnement exo
